...
<section class="material-half-bg">
    <div class="cover" style="background-color: #2ecc71;"></div>
</section>
    ...
    <div class="login-box">
        <form class="login-form" id="login-form" action="{{ url('/admin/login') }}" method="post">
            ...
            <div class="form-group">
                ...
                <input class="form-control" style="border-color: #2ecc71" name="username" type="text" placeholder="Username" autofocus>
            </div>
            <div class="form-group">
                <label class="control-label">PASSWORD</label>
                <input class="form-control" style="border-color: #2ecc71" name="password" type="password" placeholder="Password">
            </div>


            <div class="form-group btn-container" id="working">
                <button class="btn btn-primary btn-block login-button-pranto" style="background: #2ecc71; border-color: #2ecc71"><i class="fa fa-sign-in fa-lg fa-fw"></i>SIGN IN</button>
            </div>
            <br>
            <a href="{{route('admin.password.request')}}" style="color: #2ecc71;">Forgot Password?</a>

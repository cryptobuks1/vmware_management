                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="demo-content">
                                                ...
                                                <div class="demo-text">
                                                    <h6>Template One</h6>
                                                    <button class="btn btn-primary" @if($general->template_active == 1) disabled  @endif type="submit">Active</button>
                                                </div>
                                            </div>
                                            </form>
                                            <!-- Demo Content End -->
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="demo-content">
                                                ...
                                                <div class="demo-text">
                                                    <h6>Template Two</h6>
                                                    <button @if($general->template_active == 2) disabled  @endif class="btn btn-primary" type="submit">Active</button>
                                                </div>
                                            </div>
                                            </form>
                                            <!-- Demo Content End -->
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="demo-content">
                                                ...
                                                <div class="demo-text">
                                                    ...
                                                    <button @if($general->template_active == 3) disabled  @endif class="btn btn-primary" type="submit">Active</button>
                                                </div>
                                            </div>
                                            </form>
                                            <!-- Demo Content End -->
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="demo-content">
                                                ...
                                                <div class="demo-text">
                                                    <h6>Template Three</h6>
                                                    <button @if($general->template_active == 4) disabled  @endif class="btn btn-primary" type="submit">Active</button>
                                                </div>
                                            </div>
                                            </form>
                                            <!-- Demo Content End -->

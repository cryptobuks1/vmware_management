                    ...
                    <div class="step-installer first-installer second-installer third-installer">
                        ...
                        <div class="installer-content">
                            <form action="?action=install" method="post">
                                ...
                                <input class="form-control input-lg" name="user" placeholder="Envato Username"
                                       type="text" required=""><br>
                                <input class="form-control input-lg" name="code" placeholder="Purchase Code" type="text"
                                       required=""><br>
                                <hr style="background: #777; height: 1px;">
                ...
                <div class="step-installer first-installer">
                    ...
                    <div class="installer-content">
                        <p style="text-align: left;">
                            ...
                            <br><br>
                            For more information, Please Check <a href="https://codecanyon.net/licenses/faq"

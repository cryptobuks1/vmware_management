...
>
    ...
    <ul class="nav nav-treeview">
        <li class="nav-item">
            <a href="{{route('vm.requirement_classify')}}"
               @if(request()->path() == 'vm/requirement_classify') class="nav-link active"
               @else  class="nav-link" @endif>
        ...
        <li class="nav-item">
            <a href="{{route('vm.change_proposal')}}"
               @if(request()->path() == 'vm/change_proposal') class="nav-link active"
               @else  class="nav-link" @endif>
                <i class="fas fa-hat-cowboy-side nav-icon"></i>
